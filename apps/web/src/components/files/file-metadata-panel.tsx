...
import type { FileMetadataDetail } from "@ai-avatar-video-generator/shared";
      ...
      <CardContent className="space-y-3 px-5 pb-5">
        ...
        {metadata.duration_seconds !== null && (
          <>
            ...
            <MetaRow
              label="Duration"
              value={metadata.duration_human ?? `${metadata.duration_seconds.toFixed(1)}s`}
            />
          </>
        )}
